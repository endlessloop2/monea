...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MoneaNetwork") type = MoneaNetwork;
    if(strType == "MoneaNetworkVariable") type = MoneaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MoneaNetwork) s = "MoneaNetwork";
    if(type == MoneaNetworkVariable) s = "MoneaNetworkVariable";
