 ...
 *
 *   // network
 *   CMoneaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.monea.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMoneaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: MoneaNetwork
// //   -- signature requirements : Key1(User)
// class CMoneaNetworkVariable : public CGovernanceObject
// {
// private:
