...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Monea related functionality
...
/*
    ...
    allow endless transaction that would bloat Monea and make it unusable. To
