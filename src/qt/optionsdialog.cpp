    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MNA-light"), QVariant("light"));
    ui->theme->addItem(QString("MNA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MNA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MNA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MNA-traditional"), QVariant("trad"));
