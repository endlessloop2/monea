    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Monea Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Monea address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and monea: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Monea Core"), this);
    aboutAction->setStatusTip(tr("Show information about Monea Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Monea Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Monea addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Monea addresses"));
    ...
    openAction->setStatusTip(tr("Open a monea: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Monea Core help message to get a list with possible Monea Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Monea Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Monea network", "", count));
    } else {
...
{
    QString strTitle = tr("Monea Core"); // default title
