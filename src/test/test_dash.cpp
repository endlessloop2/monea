...
#define BOOST_TEST_MODULE Monea Test Suite

#include "test_monea.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_monea_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
