...
This mechanism has been integrated into Bitcore-Node-Monea which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/moneapay/insight-api-monea#web-socket-api](https://github.com/moneapay/insight-api-monea#web-socket-api)
* API: [https://github.com/moneapay/insight-api-monea#instantsend-transactions](https://github.com/moneapay/insight-api-monea#instantsend-transactions)
...
By default, the Monea Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Monea Core daemon:
