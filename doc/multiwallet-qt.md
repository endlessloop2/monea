...
Only requiring some minor changes is monea.cpp.
...
Changes to monea.cpp
----------------------
monea.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
